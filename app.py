    ...
    if request.method == "POST" and "image" in request.files:
        ...
        if file:
            ...
            try:
                ...
                return render_template("index.html", result={"error": "Upload failed"}, image_path=None)
...
def capture():
    try:
        ...
        return render_template("index.html", result={"error": "Capture failed"}, image_path=None)
